...
class UCCA_Parser(torch.nn.Module):
    ...
    def parse(self, word_idxs, pos_idxs, dep_idxs,  passages, trees=None, all_nodes=None, all_remote=None):
        spans, sen_lens = self.shared_encoder(word_idxs, pos_idxs, dep_idxs)
